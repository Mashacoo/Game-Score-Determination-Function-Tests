   ...
   """
    ...
    while left <= right:
        ...
        if game_stamps[middle]["offset"] == offset:
            ...
            return f"For offset: {offset} results are: Home score:{home}, Away score: {away}"
        else:
            if offset < game_stamps[middle]["offset"]:
                right = middle - 1
            else:
                left = middle + 1

    return f"Game stamp with offset: {offset} does not exist. Try again"
